...
public class PanacheDynamoDbEntityEnhancer extends PanacheEntityEnhancer {

    private final TypeBundle typeBundle;
    private final MetamodelInfo modelInfo;

    public PanacheDynamoDbEntityEnhancer(IndexView index, List<PanacheMethodCustomizer> methodCustomizers,
